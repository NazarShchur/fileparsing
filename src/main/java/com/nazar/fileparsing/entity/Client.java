...
public class Client extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.nazar.fileparsing.entity.Client.Builder newBuilder() {
    return new com.nazar.fileparsing.entity.Client.Builder();
  }
   ...
   * @return A new Client RecordBuilder
   */
  public static com.nazar.fileparsing.entity.Client.Builder newBuilder(com.nazar.fileparsing.entity.Client.Builder other) {
    if (other == null) {
      return new com.nazar.fileparsing.entity.Client.Builder();
    } else {
      return new com.nazar.fileparsing.entity.Client.Builder(other);
    }
  }
   ...
   * @return A new Client RecordBuilder
   */
  public static com.nazar.fileparsing.entity.Client.Builder newBuilder(com.nazar.fileparsing.entity.Client other) {
    if (other == null) {
      return new com.nazar.fileparsing.entity.Client.Builder();
    } else {
      return new com.nazar.fileparsing.entity.Client.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Client>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.nazar.fileparsing.entity.Client.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.nazar.fileparsing.entity.Client other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nazar.fileparsing.entity.Client.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nazar.fileparsing.entity.Client.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nazar.fileparsing.entity.Client.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nazar.fileparsing.entity.Client.Builder clearPhone() {
      phone = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nazar.fileparsing.entity.Client.Builder clearAddress() {
      address = null;
